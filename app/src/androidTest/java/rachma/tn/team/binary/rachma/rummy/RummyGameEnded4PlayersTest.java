...
@LargeTest
public class RummyGameEnded4PlayersTest {
    ...
    public ActivityTestRule<RummyGameEnded> mActivityRule =
            new ActivityTestRule<RummyGameEnded>(RummyGameEnded.class) {
                ...
                protected Intent getActivityIntent() {
                    ...
                    intent.putExtra("thirdPlayerScore", 20);
                    intent.putExtra("fourthPlayerScore", 30);
    ...
    public void checkLeaderboard() {
        ...
        onView(ViewMatchers.withId(R.id.player3nameScoreboard)).check(matches(withText("C")));
        onView(ViewMatchers.withId(R.id.player3scoreScoreboard)).check(matches(withText("20")));

        onView(ViewMatchers.withId(R.id.player4nameScoreboard)).check(matches(withText("D")));
        onView(ViewMatchers.withId(R.id.player4scoreScoreboard)).check(matches(withText("30")));
